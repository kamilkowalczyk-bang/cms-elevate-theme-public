...
function generateButtonStyles(buttonStyleVariant: ButtonStyleType): CSSPropertiesMap {
  const iconStyles = {
    primary: {
      backgroundColor: 'var(--hsElevate--socialFollowIcon__backgroundColorOverride, transparent)',
      ...
      hoverBackgroundColor: 'var(--hsElevate--socialFollowIcon__hover--backgroundColorOverride, transparent)',
      ...
      activeBackgroundColor: 'var(--hsElevate--socialFollowIcon__active--backgroundColorOverride, transparent)',
