...
export const sectionColorsMap: SectionColorsMap = {
  section_variant_1: {
    ...
    sectionCaptionColor: 'var(--hsElevate--section--lightSection--1__captionColor)',
  ...
  section_variant_2: {
    ...
    sectionCaptionColor: 'var(--hsElevate--section--lightSection--2__captionColor)',
  ...
  section_variant_3: {
    ...
    sectionCaptionColor: 'var(--hsElevate--section--lightSection--3__captionColor)',
  ...
  section_variant_4: {
    ...
    sectionCaptionColor: 'var(--hsElevate--section--darkSection--1__captionColor)',
